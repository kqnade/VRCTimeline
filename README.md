...
VRChat 起動中に現在のワールド・プレイヤー情報をリアルタイム表示します。  
...
設定 →「過去データをインポート」セクション →  

「VRChatActivityLogViewerのDBをインポート」ボタン  

→ VRChatActivityLog.db ファイルを選択
...
&#x20;  Microsoft 公式サイト（https://dotnet.microsoft.com/ja-jp/download/dotnet/8.0）  

&#x20;  から「.NET デスクトップ ランタイム 8.x.x」→「x64」を選択してください。  
...
ver 1.0.1  稀にVRChat起動時にアクティビティを記録できない問題の修正
